...
karen = User.create(name: 'Darius', age: 23, fitness_level: 'active')

push_up = Exercise.create(name: 'Push-up', description: 'Push your body up and away from the ground', body_part: 'Chest')
pull_up = Exercise.create(name: 'Pull-up', description: 'The pull-up is a closed-chain movement where the body is suspended by the hands and pulls up.', body_part: 'Back')
...
workout7 = Workout.create(session_id: 1, exercise_id: 1, sets: 20, reps: 5)
workout8 = Workout.create(session_id: 1, exercise_id: 2, sets: 10, reps: 10)
workout9 = Workout.create(session_id: 1, exercise_id: 3, sets: 20, reps: 20)
workout10 = Workout.create(session_id: 1, exercise_id: 4, sets: 10, reps: 20)
workout11= Workout.create(session_id: 1, exercise_id: 5, sets:5, reps: 20)
workout12 = Workout.create(session_id: 1, exercise_id: 6, sets:5, reps: 20)
